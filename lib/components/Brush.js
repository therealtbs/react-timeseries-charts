    ...
    _createClass(Brush, [
        {
            ...
            value: function viewport() {
                var _props = this.props, width = _props.width, timeScale = _props.timeScale;
        ...
        },
        {
            ...
            value: function renderBrush() {
                ...
                if (!this.viewport().disjoint(timeRange)) {
                    ...
                    var end = range.end();
                    var _ref2 = [timeScale(begin), 0], x = _ref2[0], y = _ref2[1];
        ...
        },
        {
            ...
            value: function renderHandles() {
                ...
                if (!this.viewport().disjoint(timeRange)) {
                    ...
                    var _ref3 = [timeScale(begin), 0], x = _ref3[0], y = _ref3[1];
